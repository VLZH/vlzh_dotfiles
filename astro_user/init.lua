...
local config = {
        ...
        polish = function()
                ...
                -- Configure theme and additional functions
                vim.o.background = "light"
                vim.api.nvim_create_user_command("GruvboxSwitch", function(opts) vim.o.background = opts.args[0] end, {
                        nargs = 1,
                ...
                -- Configure keymapping between russian and english keys
